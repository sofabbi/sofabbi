...
+ (BOOL)respText:(NSString *)text {
    ...
    GetMessageFromWXResp *resp = [GetMessageFromWXReq responseWithText:text OrMediaMessage:nil bText:YES];;
...
+ (BOOL)respImageData:(NSData *)imageData
    ...
    GetMessageFromWXResp* resp = [GetMessageFromWXReq responseWithText:nil OrMediaMessage:message bText:NO];
