...
@interface MSSBrowseBaseViewController ()<MSSBrowseCollectionViewCellDelegate>
...
- (void)swipDownAction:(UISwipeGestureRecognizer *)swip currentView:(MSSBrowseCollectionViewCell *)currentView{
    ...
    {
        [self swip:currentView Direction:@"up"];
        //向上轻扫做的事情
    ...
    {
         [self swip:currentView Direction:@"down"];
        //向下轻扫做的事情
...
- (void)swip:(MSSBrowseCollectionViewCell *)browseCell Direction:(NSString *)Direction{
    // 移除通知
